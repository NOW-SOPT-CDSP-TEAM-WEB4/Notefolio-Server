#!/bin/bash
BUILD_PATH=$(ls /home/ubuntu/notefolio/notefolio-0.0.1-SNAPSHOT.jar)
...
GREEN_APPLICATION=$GREEN_PROFILE-notefolio.jar
...
BLUE_PID=$(pgrep -f $BLUE_PROFILE-notefolio.jar)
